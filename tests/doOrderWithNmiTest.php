 ...
 *
 * @app: Carthook Tests
 * @filename: doOrderWithNmiTest
 * @author: sasokrajnc
 * @datetime: 13/10/2018 - 22:47
 * @version: doOrderWithNmiTest
 */
...
/**
 * Happy path to enable payment processor NMI and perform tests
 *
 * @group 1
 * @group nmi
 * @group web1
 */
class doOrderWithNmiTest extends MyAbstractTestCase implements Constants {
     ...
     */
    public function test_enablePaymentProcessorNmi() {
        ...
        try {
            // Start the process
            $processorStatus = $this->orderstep->enablePaymentProcessor(Steps::PAYMENT_PROCESSOR_NMI, "selenium", false);
        }
        catch (\Exception $e) {
        ...
        try {
            // Assertions
            $this->assertTrue($processorStatus, "Payment processor 'NMI' is enabled");
        }
        catch (\Exception $e) {
    ...
    public function test_AddSingleProductNoTaxNoDiscountNoFunnel() {
        ...
        // What kind of order
        $orderData = $this->noTaxNoDiscountNoFunnel("Nmi", false, "selenium");
    ...
    public function test_AddSingleProductWithDiscount() {
        ...
        // What kind of order
        $orderData = $this->withDiscount("Nmi", false, "selenium");
    ...
    public function test_AddSingleProductWithTax() {
        ...
        // What kind of order
        $orderData = $this->withTax("Nmi", false, "selenium");
    ...
    public function test_AddSingleProductWithShipping() {
        ...
        // What kind of order
        $orderData = $this->withShipping("Nmi", false, "selenium");
    ...
    public function test_AddSingleProductWithOneStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withOneStepFunnel("Nmi", false, "selenium");
    ...
    public function test_AddSingleProductWithTaxDiscountShippingOneStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withTaxDiscountShippingOneStepFunnel("Nmi", false, "selenium");
    ...
    public function test_AddSingleProductWithTaxDiscountShippingTwoStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withTaxDiscountShippingTwoStepFunnel("Nmi", false, "selenium");
     ...
     */
    public function test_disablePaymentProcessorNmi() {
        ...
        $processorStatus = $this->orderstep->disablePaymentProcessor(Steps::PAYMENT_PROCESSOR_NMI, "selenium", false);

        // Assert (Check if payment processor is disabled)
        try {
            // Assertions
            $this->assertTrue($processorStatus, "Payment processor 'NMI' is disabled");
        }
        catch (\Exception $e) {
            SlackAlerter::assertException(basename(__FILE__, ".php"),$this->getName(), $e);
        }
