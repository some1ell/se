 ...
 * @group web5
 */
class doOrderWithPayPalTest extends MyAbstractTestCase implements Constants {
    ...
    public function test_enablePaymentProcessorPayPal() {
        ...
        try {
            // Start the process
            $processorStatus = $this->orderstep->enablePaymentProcessor(Steps::PAYMENT_PROCESSOR_PAYPAL, "selenium", false);
        }
        catch (\Exception $e) {
        ...
        try {
            // Assertions
            $this->assertTrue($processorStatus, "Payment processor 'PAYPAL' is enabled");
        }
        catch (\Exception $e) {
    ...
    public function test_AddSingleProductNoTaxNoDiscountNoFunnel() {
        ...
        // What kind of order
        $orderData = $this->noTaxNoDiscountNoFunnel("PayPal", false, "selenium");
    ...
    public function test_AddSingleProductWithDiscount() {
        ...
        // What kind of order
        $orderData = $this->withDiscount("PayPal", false, "selenium");
    ...
    public function test_AddSingleProductWithTax() {
        ...
        // What kind of order
        $orderData = $this->withTax("PayPal", false, "selenium");
    ...
    public function test_AddSingleProductWithShipping() {
        ...
        // What kind of order
        $orderData = $this->withShipping("PayPal", false, "selenium");
    ...
    public function test_AddSingleProductWithOneStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withOneStepFunnel("PayPal", false, "selenium");
    ...
    public function test_AddSingleProductWithTaxDiscountShippingOneStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withTaxDiscountShippingOneStepFunnel("PayPal", false, "selenium");
    ...
    public function test_AddSingleProductWithTaxDiscountShippingTwoStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withTaxDiscountShippingTwoStepFunnel("PayPal", false, "selenium");
    ...
    public function test_disablePaymentProcessorPayPal() {
        ...
        try {
            // Assertions
            $this->assertTrue($processorStatus, "Payment processor 'PAYPAL' is disabled");
        }
        catch (\Exception $e) {
            SlackAlerter::assertException(basename(__FILE__, ".php"),$this->getName(), $e);
        }
