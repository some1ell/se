 ...
 *
 * @app: Carthook Tests
 * @filename: doOrderWithPayPalExpressTest
 * @author: sasokrajnc
 * @datetime: 22/10/2018 - 23:35
 * @version: doOrderWithPayPalExpressTest.php, v1.1
 */
...
/**
 * Happy path to enable payment processor PAYPAL EXPRESS and perform tests
 *
 ...
 * @group web5
 */
class doOrderWithPayPalExpressTest extends MyAbstractTestCase implements Constants {
     ...
     */
    public function test_enablePaymentProcessorPayPal() {
        ...
        try {
            // Start the process
            $processorStatus = $this->orderstep->enablePaymentProcessor(Steps::PAYMENT_PROCESSOR_PAYPAL_EXPRESS, "selenium", false);
        }
        catch (\Exception $e) {
        ...
        try {
            // Assertions
            $this->assertTrue($processorStatus, "Payment processor 'PAYPALEXPRESS' is enabled");
        }
        catch (\Exception $e) {
    ...
    public function test_AddSingleProductNoTaxNoDiscountNoFunnel() {
        ...
        // What kind of order
        $orderData = $this->noTaxNoDiscountNoFunnel("PayPal Express", false, "selenium");
    ...
    public function test_AddSingleProductWithDiscount() {
        ...
        // What kind of order
        $orderData = $this->withDiscount("PayPal Express", false, "selenium");
    ...
    public function test_AddSingleProductWithTax() {
        ...
        // What kind of order
        $orderData = $this->withTax("PayPal Express", false, "selenium");
    ...
    public function test_AddSingleProductWithShipping() {
        ...
        // What kind of order
        $orderData = $this->withShipping("PayPal Express", false, "selenium");
    ...
    public function test_AddSingleProductWithOneStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withOneStepFunnel("PayPal Express", false, "selenium");
    ...
    public function test_AddSingleProductWithTaxDiscountShippingOneStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withTaxDiscountShippingOneStepFunnel("PayPal Express", false, "selenium");
    ...
    public function test_AddSingleProductWithTaxDiscountShippingTwoStepFunnel() {
        ...
        // What kind of order
        $orderData = $this->withTaxDiscountShippingTwoStepFunnel("PayPal Express", false, "selenium");
     ...
     */
    public function test_disablePaymentProcessorPayPal() {
        ...
        $processorStatus = $this->orderstep->disablePaymentProcessor(Steps::PAYMENT_PROCESSOR_PAYPAL, "selenium", false);

        // Assert (Check if payment processor is disabled)
        try {
            // Assertions
            $this->assertTrue($processorStatus, "Payment processor 'PAYPAL EXPRESS' is disabled");
        }
        catch (\Exception $e) {
            SlackAlerter::assertException(basename(__FILE__, ".php"),$this->getName(), $e);
        }
